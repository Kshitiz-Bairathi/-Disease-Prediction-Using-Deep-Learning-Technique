...
class ResNet50Custom(nn.Module):
    def __init__(self):
        ...
        # Unfreeze last 10 layers (last 10 parameter groups)
        for param in list(resnet50.parameters())[-10:]:
            param.requires_grad = True

        # Extract all layers except avgpool and fc
        self.features = nn.Sequential(*list(resnet50.children())[:-2])  # up to conv5_x

        # Add adaptive max pooling to get 4x4 output
