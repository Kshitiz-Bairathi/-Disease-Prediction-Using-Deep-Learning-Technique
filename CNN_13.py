...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            ...
            nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1),  # (64, 32, 32) -> (128, 32, 32)
            nn.ReLU(),
            nn.BatchNorm2d(128),
            nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1),  # (128, 32, 32) -> (128, 32, 32)
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2),  # (128, 16, 16)

            nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1),  # (128, 16, 16) -> (256, 16, 16)
            nn.ReLU(),
            nn.BatchNorm2d(256),
            nn.Conv2d(128, 256, kernel_size=3, stride=1, padding=1),  # (256, 16, 16) -> (256, 16, 16)
            nn.ReLU(),
